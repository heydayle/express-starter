...
// client routes
router.get("/user", userCtrl.apiGetAllclients);
router.post("/user/login", userCtrl.apiCheckclient);
router.post("/user/register",userCtrl.apiCreateclient);
router.get("/user/:id", userCtrl.apiGetclientById);
router.put("/user/:id", userCtrl.apiUpdateclient);
router.delete("/user/:id", userCtrl.apiDeleteclient);
