...
module.exports = class user {
  ...
  static async apiCheckclient(req, res, next) { 
    try {
      ...
      const client = await userService.clientlogin(req.body);
  ...
  static async apiCreateclient(req, res, next) {
    try {
      ...
      const createdclient =  await userService.createclient(req.body);
  ...
  static async apiUpdateclient(req, res, next) {
    try {
      ...
      const updatedclient = await userService.updateclient(req.params.id,req.body.fullname,req.body.email,req.body.password);
  ...
  static async apiDeleteclient(req, res, next) {
    try {
      ...
      const deleteResponse = await userService.deleteclient(clientId);
